...
We had around 52 good columns and the class "classe".121 columns were discarded. All classes are to an extent represented well. Based on initial model build (model saved as RDS file "fullmodel.RDS"), top 23 (see png file) were selected.
